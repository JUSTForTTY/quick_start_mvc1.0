 ...
 * @history
 */
@Controller("goodsSecondTypeManageAction")
@RemoteProxy(name = "goodsSecondTypeManageAction")//父类路径
public class GoodsSecondTypeManageAction {

	private Log log = LogFactory.getLog(getClass());

	@Autowired
	@Qualifier("goodsSecondTypeManageBizImpl")
	private GoodsSecondTypeManageBiz goodsSecondTypeManageBiz;
	...
	public Page getList(Map<String, String> param) {
		...
		return this.goodsSecondTypeManageBiz.getList(param);
	}
	/*
	 * 
	 * 商品类别删除
	...
	public ResultBean deletes(String ids,String isDelete) {
		...
		return this.goodsSecondTypeManageBiz.delete(ids,isDelete);
	}
	/*
	 * 
	 * 根据id查询商品类别
	...
	public ResultBean getById(String id) {		
		...
		return this.goodsSecondTypeManageBiz.getById(id);
	}
	...
	public ResultBean saveOrUpdate(Map<String, String> map) {
		...
		return this.goodsSecondTypeManageBiz.saveOrUpdate(map);
