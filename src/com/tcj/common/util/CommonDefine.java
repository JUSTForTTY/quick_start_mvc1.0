...
public class CommonDefine {
	...
	public static final double size=1.3;
	
	//课程logo大小
	public static final double ACTIVITYLOGO_WIDTH = 90*size;
	
	public static final double ACTIVITYLOGO_HEIGHT = 100*size;
	//动态新闻照片大小
	public static final double DYNAMICNEWS_WIDTH = 300*size;

	public static final double DYNAMICNEWS_HEIGHT = 277*size;

	//家长必读照片大小

	public static final double MUSTREAD_WIDTH=200*size;

	public static final double MUSTREAD_HEIGHT=300*size;

	//课程体系背景图照片大小
	public static final  double CURRICULUM_WIDTH= 270*size;
	public static final  double CURRICULUM_HEIGHT= 350*size;

	//课程体系图标照片大小
	public static final  double minCURRICULUM_WIDTH= 150*size;//150
	public static final  double minCURRICULUM_HEIGHT= 150*size;//150

	//滑动新闻照片大小
	public static final double ROLLING_NEWS_WIDTH=1920 * size;

	public static final double ROLLING_NEWS_HEIGHT=1140 *size;

	//明星学员照片大小
	public static final  double  STARMEMBER_WIDTH=555*size;

	public static final double STARMEMBER_HEIGHT=721*size;

	//明星学员头像
	
	public static final double  minSTARMEMBER_WIDTH=207*size;//207
	
	public static final  double minSTARMEMBER_HEIGHT=207*size;//207
	
	
	//名师风采照片大小

	public static final double  TEACHERS_WIDTH=449*size;

	public static final  double TEACHERS_HEIGHT=800*size;

//相关视频
	public static final double VIDEOS_WIDTH=260*size;
	public static final  double VIDEOS_HEIGHT=250*size;
	//机构
	public  static final double  AGENCY_WIDTH=578*size;
	public  static final double  AGENCY_HEIGHT=401*size;
	
	
	//即客企业展示网站
	public static final String JK_PREFIX= "wuyeok"; //用于取sequence时，拼接进id中。

	public static final Integer  JK_BUILDING=10;
	//订单状态
	...
	public static final String ORDERTYPE_PAY_WAIT_FINISH="10";         //待激活  （活动专用，活动时，充值达到指定金额，赠送的赠品订单为待激活状态，在指定日期消费，才会变成已付款，发货给用户  
	...
	//用户类型
	public static final int 			USERTYPE_COMMONADMIN					 =0;//管理员
	public static final int 			USERTYPE_SUPERADMIN						 =1;//超极管理员
	public static final int        		USERTYPE_COMMONUSER						 =2;//普通用户
}
