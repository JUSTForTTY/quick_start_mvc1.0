package com.tcj.common.dao.impl;
...
public class BaseDaoImpl implements BaseDao {
	...
	public String findByjkSequence(String sql) {
		// TODO Auto-generated method stub
		 SQLQuery query = this.getSession().createSQLQuery(sql);    
//		    String str =CommonDefine.JK_PREFIX+query.uniqueResult().toString();   
		    String str =query.uniqueResult().toString();   
	...
	@Override
	public Integer saveReturnLastId(String sql) {
		// TODO Auto-generated method stub
		...
		String selectsql="SELECT LAST_INSERT_ID() AS value";
