...
@Entity
@Table(name = "t_change_goods")
@DataTransferObject
public class T_Change_Goods implements Serializable {
	...
	@GenericGenerator(name = "autoincrement", strategy = "identity")
	@RemoteProperty
	@Column(name = "EFFECT_DATE",length=0,updatable=true)
	private Date effectDate;

	@RemoteProperty
	@Column(name = "ADMIT_FLAG",length=1,updatable=true)
	...
	@RemoteProperty
	@Column(name = "MAX_NUM",length=12,updatable=true)
