...
<script type="text/javascript">
	...
	function editBtnClick(id,obj) {
		...
		// alert("你好，你的id到这了");
		var url="";
		 url = "<%=basePath%>work/news/updateNews.jsp?id="+id;

	
			easyui_openTopWindow("新闻管理 ",828,640,url,function(returnValue)
		{
			$('#dg').datagrid('reload');
		}); 
	}
	...
	function addBtnClick() {	
	    var url="";
		 url = "<%=basePath%>work/news/addNews.jsp";
	...
	function searchDate(caid,obj){
		var url="<%=basePath%>work/newsManage/newsRecoveryManage.jsp?caid="
				+ caid;
		...
		<table id="dg" class="easyui-datagrid" title="新闻管理"
			...
			<thead>
				<tr>
					...
					<th
						data-options="field:'title',width:200,editor:{type:'validatebox',options:{required:true,validType:'length[1,20]'}},align:'center',halign:'center'">新闻标题</th>
					...
					<th
						data-options="field:'name',width:200,editor:{type:'validatebox',options:{required:true,validType:'length[1,20]'}},align:'center',halign:'center'">会员单位名称</th>
					...
					<th
						data-options="field:'gmt_create',width:150,editor:{type:'validatebox',options:{required:true,validType:'length[1,11]'}},align:'center',halign:'center'">创建时间</th>
					<th
						data-options="field:'gmt_publish',width:150,editor:{type:'validatebox',options:{required:true,validType:'length[1,11]'}},align:'center',halign:'center'">发布时间</th>
