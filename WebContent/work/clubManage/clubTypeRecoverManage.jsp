		...
		function recoveryData(flag){
	       ...
	       var isDelete="0";
			...
			$.messager.confirm('确认', '确定要'+str+'吗?', function(r) {
				if (r) {
				clubTypeManageAction.deletes(ids,isDelete, {
					async : false,
...
<body class="easyui-layout">
	<div data-options="region:'north',split:false" style="height:70px">
		<div id="search"
			class="easyui-panel" title="已删除社团类别查询"
			data-options="iconCls:'icon-search'">
			<div class="box">
				<span>已删除类别名称</span> <input id="name"></input>
	...
	<div data-options="region:'center'">
		<table id="dg" class="easyui-datagrid" title="已删除社团类别恢复"
			data-options="
						fitColumns:false,
	                     fit:true,
	                     iconCls: 'icon-edit',
			...
			<thead>
				<tr>
				    ...
				    <th data-options="field:'Id',width:100,editor:{type:'validatebox',options:{required:true,validType:'length[1,20]'}},hidden:'true',align:'center',halign:'center'">id编号</th>				
