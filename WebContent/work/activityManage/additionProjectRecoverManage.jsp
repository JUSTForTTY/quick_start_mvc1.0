...
//	    alert(map["aid"]);
	...
	function recoveryData(flag){
		...
		$.messager.confirm('确认', '确定要'+str+'吗?', function(r) {
			if (r) {
				activityManageAction.deletesAddition(ids,isDelete, {
					async : false,
...
<body class="easyui-layout">
	<div data-options="region:'north',split:false" style="height:70px">
		<div id="search"
			class="easyui-panel" title="已删除附加项目查询"
			data-options="iconCls:'icon-search'">
			<div class="box">
				<span>已删除附加项目名称</span> <input id="name"></input>
	...
	<div data-options="region:'center'">
		<table id="dg" class="easyui-datagrid" title="已删除附加项目恢复"
			data-options="
						fitColumns:false,
	                     fit:true,
	                     iconCls: 'icon-edit',
...
<!-- 					<th data-options="field:'content',width:100,editor:{type:'validatebox',options:{required:true,validType:'length[1,11]'}},align:'center',halign:'center'">附加项目内容</th> -->
		...
		<a id="delBtn" href="javascript:void(0)" class="easyui-linkbutton" style="margin-left: 10px;"
				data-options="iconCls:'icon-back',plain:true" onclick="recoveryData(0)">恢复数据</a>
		</div>
	</div>
</body>
</html>
