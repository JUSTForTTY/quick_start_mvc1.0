...
<script type="text/javascript">
		...
		//	alert("保存操作");
			...
			if(CKEDITOR.instances.mobilecontent.getData()=="")
			{
				$.messager.alert('警告', "请输入手机内容！",'warning');	
				return;
			}
			//组装map
		...
		<table border="0px">
			...
			<tr>
				<td>		
					...
					</div> <input type="hidden" id="nid" />
					<div class="clear"></div>

					<div class="lableLine350">
						<div class="lableWidth120">英文标题</div>
						<input name="englishTitle" id="englishTitle" style="width: 350px;"
							class="easyui-validatebox"
							data-options="required:true,validType:'length[1,100]'" />
					</div>
					<div class="clear"></div>
					<div class="lableLine350">
						<div class="lableWidth120">是否首页显示</div>

						<select name="onhome" id="onhome" class="easyui-validatebox"
					...
					<div class="clear"></div>
                         <div class="lableLine350">
						<div class="lableWidth120">概要</div>
				...
				<td>
					<img src="" style="width:200px;height:200px;visibility:hidden;" id="imageView" >
				</td>
			</tr>
			<tr>
				<td colspan="2" >		
					<div id="div_file1">
							<ul class="PoyBt FileItem file1"  style="padding-left:0px;border:0px solid blue;"  id="file1">
								...
								<li class="Poy_si" style="padding-top: 0px; height: 32px;width:230px;">
									...
									<p style="color:red; float:right;">图片要求宽300像素*高277像素</p>
								</li>
			...
			<tr>
				...
				<td colspan="2">
					...
					</div> <input id="caid" name="caid" type="hidden"
					value="<%=request.getParameter("caid")%>"  />
					<div class="clear"></div>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2">
					<div class="lableLine650">
						<div class="lableWidth120">手机内容</div>
						<div class="lableLine530">
							<input name="mobilecontent" id="mobilecontent" class="ckeditor" />
						</div>
			</div>
			</td>
			</tr>
