	  ...
	  <table>
	   ...
	   <div id="div_file1">
							<ul class="PoyBt FileItem file1" style="padding-left:0px;" id="file1">
								...
								<li class="Poy_si" style="padding-top: 0px; height: 32px;width:210px;">
									<p class="Btn UploadBtn NomalUploadBtn" style="cursor: default;"></p>
									<p style="color:red; float:right;">图片要求宽578px*高401px</p>
									<img style="float:top; margin-left:60px; width: 200px;height:200px; line-height: 23px;  margin-top: -200px;visibility:hidden;" id="imageView">
								</li>
