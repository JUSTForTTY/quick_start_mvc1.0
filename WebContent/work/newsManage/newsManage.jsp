...
// 	}
	...
	function editBtnClick(nid,caid,obj) {
		...
		var url="";
		if(caid==1 || caid==2)
		 url = "<%=basePath%>work/newsManage/newsSubManage.jsp?nid="+nid+"&&caid="+caid;
// 		if(caid==3)
<%-- 			url="<%=basePath%>work/newsManage/courseSubManage.jsp?nid="+nid+"&&caid="+caid; --%>
		if(status==1)
		url="<%=basePath%>work/newsManage/newsStatusSubManage.jsp?nid="+nid+"&&caid="+caid+"&&status="+status;
	...
	//	alert("点击新增传所属类别caid="+caid);
		var url="";
		if(caid==1 || caid==2)
		 url = "<%=basePath%>work/newsManage/newsSubManage.jsp?caid="+caid;
		if(caid==3)
			url="<%=basePath%>work/newsManage/courseSubManage.jsp?caid="+caid; 
