...
<script type="text/javascript">
	...
	function editBtnClick(nid,caid,obj) {
		...
		var url="<%=basePath%>work/newsManage/famousSubTeacher.jsp?nid="+nid+"&&caid="+caid;
		
		easyui_openTopWindow("名师风采",755,467,url,function(returnValue)
		{
			$('#dg').datagrid('reload');
		}); 
	}
	...
	//	alert(caid);
		...
		var url="<%=basePath%>work/newsManage/famousSubTeacher.jsp?caid="+caid;
		...
		<table id="dg" class="easyui-datagrid" title=" "
			...
			<thead>
				<tr>
                   ...
                   <th data-options="field:'englishTitle',width:200,editor:{type:'validatebox',options:{required:true,validType:'length[1,20]'}},align:'center',halign:'center'">英文名</th>
