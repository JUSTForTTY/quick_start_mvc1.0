...
// alert(cid);
// 	根据cid查询数据,做修改前处理。
		if (parentId!=null&&parentId!=""&&secondId!=null&&secondId!="") {
			alert(secondId);
			goodsSecondTypeManageAction.getById(secondId, {
				async : false,
...
// 		 alert("新增");
	...
	goodsSecondTypeManageAction.saveOrUpdate(map, {
