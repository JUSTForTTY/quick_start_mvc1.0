...
**************************/
		var filePath = "/WelltransBusinessService/script/";
	...
	try{		     
		...
		if (navigator.userAgent.indexOf('Win64')>=0){
	     ...
	     //=====如下空白位置适合调用统一功能:=====	     
	     LODOP.SET_LICENSES("","380929710710896110116541091201","688858710010010811411756128900","742464556525055566256606556128");
	     //=======================================
	     return LODOP; 
	}catch(err){
		if (navigator.userAgent.indexOf('Win64')>=0)	
