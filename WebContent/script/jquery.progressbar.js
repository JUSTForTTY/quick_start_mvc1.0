	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'progressbarimages/progressbg_green.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '/SafeLease/css/progressbarimages/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/SafeLease/css/progressbarimages/progressbg_red.gif',
									30: '/SafeLease/css/progressbarimages/progressbg_orange.gif',
									70: '/SafeLease/css/progressbarimages/progressbg_green.gif'
								},
